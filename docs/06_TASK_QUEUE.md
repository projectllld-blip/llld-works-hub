...
- v1系ロードマップは、v1.3で購入前後の利用開始フロー整理、v1.4で実アプリの商品化方針整理、v1.5で販売用UI/UX強化、v1.6で購入ページ、v1.7で購入後の利用開始・利用中アプリ反映、v1.8a〜v1.8cで商品・料金・CTA管理方針を整理し、v1.8で販売前QAを行い、v1.9で初めて決済・購入履歴へ進む。
...
- v1.6 購入ページでは、決済なしの購入 / 利用開始確認ページを整える。商品・料金・CTAは当面 `data/contents.json` と画面JSに残るが、決済前に本物管理者画面 / 商品マスタ / 料金マスタで管理する方針を別フェーズで整理する。
- v1.8a 商品・料金管理 方針整理では、商品名、料金形態、価格、CTA、掲載状態、任意サポート、変更履歴、管理者権限、RLS / 管理者APIの要否を整理する。本物管理者画面やDB変更は人間判断後に別フェーズで扱う。
