...
- v1.6c 管理者mock画面では、実DB接続なしの固定mockで、商品一覧、価格、無料 / β版 / 買い切り / サブスク / 開発相談 / 開発中、表示状態、CTA種別、サポート設定、初期設定サポート有無、購入後の反映先 `app_key`、異常状態を確認するUIを追加した。本物DB編集、商品DB、料金DB、Supabase / RLS / migration変更は含めない。
