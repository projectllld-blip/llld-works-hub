...
- v1.5 販売用UI/UX強化。
  - Works Marketの商品カードと詳細ページで、無料 / 有料化予定 / β版 / 準備中を見分けられるようにする。
  - 相談型コンテンツは通常商品カードから分離し、導入相談・カスタマイズ相談セクションへ寄せる。
  - 決済、DB更新、利用開始処理は含めない。
- v1.6 購入ページ。
...
v0.14.12、v0.15、v0.16、v0.17a、v0.18、v1.0、v1.1b、v1.2、v1.2bは完了扱い。v0.17b以降はmain未反映のためPARKEDに戻したまま、次は v1.3 購入前後の利用開始フロー整理へ進む。
...
- v1.5では、商品化分類を販売画面の見え方へ反映し、v1.6購入ページへ進む前の状態表示とCTAを整える
