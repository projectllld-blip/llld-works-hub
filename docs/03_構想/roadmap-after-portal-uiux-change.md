...
v0.14.12、v0.15、v0.16、v0.17a、v0.18は完了扱い。v0.17b以降はmain未反映のためPARKEDに戻したまま、現在は v1.0 アカウント別クラウド基盤MVP完成の条件整理を進める。
...
- v1.0では、PARKED範囲を含めず、アカウント別クラウド基盤MVPとしての完成条件を整理する
