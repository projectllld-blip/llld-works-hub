...
現在の作業対象は v1.6 購入ページ。決済実装には入らず、`purchase-confirm.html` で購入 / 利用開始確認、任意サポート選択、ポータルへの一時追加導線を整理している。あわせて、将来の商品・料金・CTA管理を本物管理者画面へ分離するロードマップを整理している。
...
v1系ロードマップは、購入前後の利用開始フロー、実アプリの商品化方針、販売用UI/UX、購入ページ、購入後の利用開始・利用中アプリ反映、商品・料金管理方針、販売前QAの後に決済・購入履歴へ進む順番へ見直す。
...
- 管理者画面・料金管理ロードマップ整理: 商品名、料金形態、価格、CTA、掲載状態、任意サポートなどは将来の本物管理者画面 / 商品マスタで扱う。v1.6では実装しない。
...
- v1.8a 商品・料金管理 方針整理: 決済前に、商品マスタ、料金マスタ、CTA管理、管理者権限、変更履歴の扱いを整理する。
