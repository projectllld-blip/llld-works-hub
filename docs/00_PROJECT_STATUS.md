...
現在はv1.2b 企業情報編集フォームMVPと、A0.8/A0.9 docs-only自動マージ判定の厳密化まで完了。次の本線候補は v1.3 アプリ追加申請。

v1.3a アプリ追加申請UI mockはPR #21でmain反映済み。ただし人間ブラウザ確認で申請エリアが見つけにくい問題があり、追加修正PRで表示を明確化中。DB保存なしで、`account.html` 上に未利用アプリの申請導線を追加する。正式なDB保存は未実装で、専用テーブル / RLS / migration設計が必要なため別Phaseで扱う。
...
## 進行中の本線
- v1.3a アプリ追加申請UI mock 追加修正: `account.html` の申請エリアを明確化。追加修正PR作成、ブラウザ確認、main反映確認待ち。
...
## 次の本線候補
- v1.3a アプリ追加申請UI mockの人間確認・main反映確認
- v1.3b アプリ追加申請DB保存設計
- v1.4 購入ページ
- v1.5 決済・購入履歴
- v1.6 実アプリの商品化
