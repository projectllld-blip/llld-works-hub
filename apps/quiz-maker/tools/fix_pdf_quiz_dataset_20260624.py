...
def build_plans() -> list[Plan]:
    social_plans = [
        ...
        ], extra_answer_file="中学受験新演習小４下　社会　答え.pdf", extra_answer_page=1, extra_answer_unit=18, extra_answer_crop=TL, rotate_visual=90),
        Plan("中学受験新演習小5上　社会.pdf", "中受新演習小5上", "社会", "中学受験新演習", "小5上", 20, [
            answer_blocks(21, [1, 2, 3, 4], "social"),
            answer_blocks(22, [9, 10, 11, 12], "social"),
            answer_blocks(23, [17, 18, 19, 20], "social"),
        ], rotate_visual=90),
        Plan("中学受験新演習小5下　社会.pdf", "中受新演習小5下", "社会", "中学受験新演習", "小5下", 18, [], rotate_visual=90),
